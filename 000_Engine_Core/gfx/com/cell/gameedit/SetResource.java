...
//	-------------------------------------------------------------------------------------
	...
	final public Map<String, ImagesSet>		ImgTable;
	final public Map<String, SpriteSet>		SprTable;
	final public Map<String, MapSet>		MapTable;
	final public Map<String, WorldSet>		WorldTable;
	final public Map<String, TableSet>		TableGroups;
...
//	--------------------------------------------------------------------------------------------------------------------------------------------------
	...
	final public void initAllResource(SetLoading progress)
	{
		...
		// sprites
		{
			...
			int index = 0;
			for (SpriteSet ss : SprTable.values()) {
		...
		// worlds
		{
			...
			int index = 0;
			for (WorldSet ws : WorldTable.values()) {
...
//	########################################################################################################################
	...
	public CMap createMapFromSet(MapSet tmap, IImages tiles, boolean isCyc)
	{
...
//	########################################################################################################################
	...
	public CWayPoint[] createWayPointsFromSet(Map<Integer, WaypointObject> waypoints)
	{
	...
	public CCD[] createRegionsFromSet(Map<Integer, RegionObject> regions)
	{
...
//	-------------------------------------------------------------------------------------
	...
	public LoadSpriteTask createLoadSpriteTask(
			SpriteSet spr, 
