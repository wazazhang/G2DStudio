...
public class CCollides extends CGroup
{
	 ...
	 * @param h hight
	 */
	public void addCDRect(int mask, float x, float y, float w, float h) {
	 ...
	 * @param qy point 2 y
	 */
	public void addCDLine(int mask, float px, float py, float qx, float qy) {
	 ...
	 * @param color 
	 */
	public void render(IGraphics g,int index,float x,float y,int color){
//#ifdef _DEBUG
...
//#endif
	 ...
	 * @param color 
	 */
	public void renderSub(IGraphics g,int index,int sub,float x,float y,int color){
//#ifdef _DEBUG
