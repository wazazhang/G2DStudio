...
public class CryptTool extends JFrame implements ActionListener, WindowListener
{
	...
	JButton		btn_encrypt_base64	= new JButton("encrypt_base64");
	JButton		btn_decrypt_base64	= new JButton("decrypt_base64");
	...
	public CryptTool()
	{
		...
		
		{
			JPanel panel_dst = new JPanel(new BorderLayout());
			{
				...
				{
					JPanel panelk1 = new JPanel(new GridLayout(1, 4));
					JPanel panelk2 = new JPanel(new GridLayout(1, 4));
					
					panelk1.add(btn_encrypt);
					panelk1.add(btn_encrypt_hex);
					panelk1.add(btn_encrypt_base64);
					panelk2.add(btn_decrypt);
					panelk2.add(btn_decrypt_hex);
					panelk2.add(btn_decrypt_base64);
					...
					btn_encrypt_base64.setActionCommand("encrypt_base64");
					btn_decrypt_base64.setActionCommand("decrypt_base64");
					...
					btn_encrypt_base64.addActionListener(this);
					btn_decrypt_base64.addActionListener(this);
					
					south.add(panelk1);
					south.add(panelk2);
				}
				panel_dst.add(south, BorderLayout.SOUTH);
			}
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		else if (e.getActionCommand().equals("encrypt_base64")) {
			text_dst.setText(Crypt.encryptBase64(text_src.getText(), text_key.getText()));
		}
		else if (e.getActionCommand().equals("decrypt_base64")) {
			text_dst.setText(Crypt.decryptBase64(text_src.getText(), text_key.getText()));
		}
	}
