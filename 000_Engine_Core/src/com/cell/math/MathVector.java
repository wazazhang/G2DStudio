...
public class MathVector
{
	...
	public static boolean moveToX(Vector v, double x, double distance){
		double ddx = x - v.getVectorX();
	...
	public static boolean moveToY(Vector v, double y, double distance){
		double ddy = y - v.getVectorY();
