...
public class Parser {
	...
	public static <T> T stringToObject(String str, Class<T> return_type) {
		try {
			return stringToObjectP(str, return_type);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	...
	public static <T> T stringToObjectP(String str, Class<T> return_type) throws Exception {
		if (str == null) {
			return null;
		}
		try {
	...
	public static Object getZeroValue(Class<?> type) {
		if (type.isPrimitive()) {
	...
	public static byte parseByte(String str) {
		long full = str.startsWith(PERFIX_RADIX_16) ? Long.parseLong(str.substring(PERFIX_RADIX_16.length()), 16)
				: Long.parseLong(str);
