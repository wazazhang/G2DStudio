...
public class FileFilters
{
	...
	public FileFilters(String regex) 
	{
		String dir_regex = "";
		String file_regex = "";
		String[] fts = CUtil.splitString(regex, ";", true);
	...
	{
		if (file.isDirectory()) {
			throw new RuntimeException("Directory not support file filter : " + file.getPath());
		}
		if (!filter_dir.accept(file.getParent())) {
			return false;
		}
		if (!filter_file.accept(file.getPath())){
			return false;
		}
		return true;
	}
