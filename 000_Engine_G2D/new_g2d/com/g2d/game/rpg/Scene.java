...
//	---------------------------------------------------------------------------------------------------------------------------
//	
	protected SceneObjectLayer			world;
...
//	---------------------------------------------------------------------------------------------------------------------------
	...
	public Scene(SceneObjectLayer world) {
		this.setSize(640, 480);
		this.world = world;
	...
	public boolean addChild(DisplayObject child) {
		if (child instanceof SceneObjectLayer && world==null){
			this.world = (SceneObjectLayer)child;
	...
	public void setWorld(SceneObjectLayer world) {
		addChild(world);
	}
	
	public SceneObjectLayer getWorld() {
		return world;
	}
