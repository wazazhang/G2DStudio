...
public abstract class SceneObjectLayer extends DisplayObjectContainer implements AstarManhattanMap
{
...
//	---------------------------------------------------------------------------------------------------------------------------
	...
	public SceneObjectLayer(Scene scene, 
			int grid_w, 
			int grid_h, 
			int grid_x_count,
			int grid_y_count,
...
//		---------------------------------------------------------------------------------------------------------------------------
	...
	abstract public void renderStaticMaps(Graphics2D g, float cx, float cy, float cw, float ch);
