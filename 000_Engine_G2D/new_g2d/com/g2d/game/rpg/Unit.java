...
//	------------------------------------------------------------------------------------------------------------------------------------
	...
	private transient SceneObjectLayer	owner_world;
...
//	------------------------------------------------------------------------------------------------------------------------------------
	...
	protected boolean setID(SceneObjectLayer world, Object new_id) {
	...
	void setOwnerWorld(SceneObjectLayer owner_world) {
	...
	public SceneObjectLayer getOwnerWorld() {
		return owner_world;
	}
