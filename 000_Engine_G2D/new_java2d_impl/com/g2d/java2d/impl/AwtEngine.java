...
//		throw new NotImplementedException("can not unwrap image!");
	...
	static public com.g2d.geom.Rectangle wrap(java.awt.Rectangle img) 
	{
		return new com.g2d.geom.Rectangle(img.x, img.y, img.width, img.height);
	}
	static public java.awt.Rectangle unwrap(com.g2d.geom.Rectangle img) 
	{
		return new java.awt.Rectangle(img.x, img.y, img.width, img.height);
	}
