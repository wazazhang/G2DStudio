...
import com.g2d.studio.gameedit.ObjectTreeViewTemplateXLS;
...
public class ShopItemTreeView extends ObjectTreeViewTemplateXLS<XLSShopItem, TShopItem>
{
	...
	public ShopItemTreeView(String title, com.g2d.studio.io.File objects_dir,
			XLSDataSource xls_file, ProgressForm progress) {
		super(title, XLSShopItem.class, TShopItem.class, objects_dir, xls_file,
				progress);
	}
