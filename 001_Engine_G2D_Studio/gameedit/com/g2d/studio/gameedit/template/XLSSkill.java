...
import com.g2d.studio.gameedit.template.util.SkillViewer;
import com.g2d.studio.res.Res;

final public class XLSSkill extends XLSTemplateNode<TSkill>
{
	public XLSSkill(XLSFullRow xls_row, TemplateNode data) {
		super(xls_row, data);		
	...
	@Override
	protected TSkill newData(XLSFullRow xlsRow) {
