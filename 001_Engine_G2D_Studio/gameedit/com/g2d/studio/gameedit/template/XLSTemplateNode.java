...
//	final XLSFile		xls_file;
	...
	XLSTemplateNode(XLSFullRow xls_row, TemplateNode data) 
	{
		this.xls_fullrow	= xls_row;
		this.template_data	= (data == null) ? newData(xls_row) : (T)data;
...
//		System.out.println("read a xls row : " + xls_file.xls_file + " : " + xls_fullrow.id + " : " + xls_fullrow.desc);
	 ...
	 * @return
	 */
	abstract protected T newData(XLSFullRow xls_row) ;
