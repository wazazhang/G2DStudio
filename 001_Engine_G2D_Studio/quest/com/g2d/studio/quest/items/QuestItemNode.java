...
public class QuestItemNode extends DynamicNode<QuestItem>
{
	...
	public QuestItemNode(QuestNode quest, String name, Boolean is_award) throws Exception
	{
		super(quest.getQuestItemManager(), 
				quest.getQuestItemManager().idf().createID(), name, is_award);
