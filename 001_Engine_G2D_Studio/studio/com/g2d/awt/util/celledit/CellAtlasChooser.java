...
public class CellAtlasChooser extends AbstractOptionDialog<CellAtlasIndex>
{
	...
	public CellAtlasChooser(CellTilesResource res, Frame parent) throws Exception 
	{
		super(parent);
	...
	@Override
	protected CellAtlasIndex getUserObject(ActionEvent e) {
		CellAtlasIndex index = list.getSelectedAtlas();
		return index;
	}

	public static CellAtlasIndex showDialog(Frame parent, CellTilesResource res) {
		try {
			return new CellAtlasChooser(res, parent).showDialog();
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static CellAtlasIndex showDialog(Frame parent, File defaultFile) 
	{
