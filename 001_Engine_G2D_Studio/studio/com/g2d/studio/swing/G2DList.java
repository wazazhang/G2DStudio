...
public class G2DList<T extends G2DListItem> extends JList
{
	...
	public G2DList()
	{
		...
		this.addListSelectionListener(new ListSelect());
	}
	...
	public void setListItems(Collection<T> list)
	{
		super.setListData(list.toArray());
	}
	public void setListItems(T[] list)
	{
...
//				}
	...
	protected class ListSelect implements ListSelectionListener
	{
		public void valueChanged(ListSelectionEvent e) {
			G2DList<T> list = G2DList.this;
			T value = getSelectedItem();
			if (value != null) {
				value.onSelected(list);
			}
		}
	}
		...
		public void mouseClicked(MouseEvent e) {
			...
			if (value != null) {
				if (e.getButton() == MouseEvent.BUTTON3) {
					value.onRightClicked(list, e);
				} else if (e.getButton() == MouseEvent.BUTTON1) {
					if (e.getClickCount() == 2) {
						value.onDoubleClicked(list, e);
					} else {
						value.onClicked(list, e);
					}
				}
