...
//	-------------------------------------------------------------------------------------------------------
	...
	public static class NodeMenu<T extends G2DTreeNode<?>> extends JPopupMenu implements ActionListener, Externalizable
	{
		...
		protected JMenuItem resetid = new JMenuItem(
				"<html><body><p><font color=\"#0000ff\">重设ID</font></p></body></html>");
		protected JMenuItem delete = new JMenuItem(
				"<html><body><p><font color=\"#ff0000\">删除</font></p></body></html>");
		protected JMenuItem copy = new JMenuItem(
				"<html><body><p><font color=\"#008000\">复制</font></p></body></html>");
		...
		public NodeMenu(T node)
		{
			...
			rename.addActionListener(this);
			resetid.addActionListener(this);
			delete.addActionListener(this);
		...
		public void actionPerformed(ActionEvent e) 
		{
			if (e.getSource() == open) {
				...
				System.out.println(node.getName() + " - copy");
			}
		}
