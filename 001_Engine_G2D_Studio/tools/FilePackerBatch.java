...
*/
		static public void main(String[] args) throws Throwable
		{
			...
			{
				File mpq_zip = new File(mpq.getPath()+".zip");
				ZipFiles.main(new String[]{"A", "-os", mpq_zip.getPath(), mpq.getPath(), "+"+dst_ext+"$"});
				System.out.println("Zip File : " + mpq + " -> .zip - " +
