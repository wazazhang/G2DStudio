...
public class FilePackerBatchBC 
{
...
*/
		static public void main(String[] args) throws Throwable
		{
			...
			{
				File mpq_zip = new File(mpq.getPath()+".mgz");
				ZipFiles.main(new String[]{"G", mpq_zip.getPath(), mpq.getPath()});
				System.out.println("Zip File : " + mpq + " -> .mgz - " +
