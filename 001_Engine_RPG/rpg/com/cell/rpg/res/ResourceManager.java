...
public abstract class ResourceManager extends CellSetResourceManager implements ParticleDisplayResource
{
...
//							System.out.println(type.getSimpleName() + " : " + id + " - " + f);
				...
				if (table != null)
				{
					...
					if (PRINT_VERBOS)
					System.out.println("\tget " + type.getSimpleName() + " : " + set + "(" + set.getID() + ")");
		
					table.put(Integer.parseInt(set.getID()), set);
				}
			}
