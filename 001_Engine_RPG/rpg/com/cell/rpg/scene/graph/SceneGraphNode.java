		...
		for (SceneUnit unit : scene.scene_units) {
			...
			if (tp != null) {
				try{
					...
					System.err.println(
							"scene ["+scene_name+"("+scene_id+")] link error at ["+ unit.name+"("+ unit.getID() +")]");
					err.printStackTrace();
				}
			}
		}
...
//	--------------------------------------------------------------------------------------------
	...
	public static class LinkInfo
	{
		...
		public float this_scene_obj_x;
		public float this_scene_obj_y;
		public float next_scene_obj_x;
		public float next_scene_obj_y;
	...
	public static class SceneGraphPath
	{
		public SceneGraphNode src;
		public SceneGraphNode dst;
		public ArrayList<LinkInfo> links = new ArrayList<SceneGraphNode.LinkInfo>();
	}
}
