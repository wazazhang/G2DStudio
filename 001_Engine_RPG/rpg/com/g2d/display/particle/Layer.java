...
//	------------------------------------------------------------------------------------------------------------------
	...
	/** 粒子生命周期时间范围(帧)*/
	public int		particle_min_age 		= 30, 
					particle_max_age 		= 60;
	
	/** 每隔多少帧释放一次粒子 */
	public int		particles_delay_frame 	= 0;
...
//	------------------------------------------------------------------------------------------------------------------
	...
	public static class TimeNode implements Comparable<TimeNode>, Serializable
	{
		...
		public float	scale_end_x		= 1;
		public float	scale_end_y		= 1;
		public boolean	end_size		= false;
		
		/** 旋转变化 */
		public float	spin			= 0;
		public boolean	enable_spin		= true;
		
		public float	spin_end		= 0;
		public boolean	end_spin		= false;
