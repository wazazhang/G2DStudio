...
final public class NetPackageProtocol 
{
	...
	final public static NetPackageProtocol createChannelMessage(int channelID, Message message) {
		NetPackageProtocol ret = new NetPackageProtocol();
	...
	final public static NetPackageProtocol createSessionMessage(Message message) {
		NetPackageProtocol ret = new NetPackageProtocol();
	...
	final public static NetPackageProtocol createSystemMessage(Message message) {
		NetPackageProtocol ret = new NetPackageProtocol();
